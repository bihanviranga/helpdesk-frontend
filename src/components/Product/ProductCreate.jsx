...
import { fetchAllCompanies , createProduct } from '../../redux';
          ...
          <DialogContentText id="alert-dialog-description">
            <form className={classes.form} noValidate>
              <Grid container spacing={2}>
                  <Grid item xs={12}>
                  <TextField variant="outlined" required fullWidth name="ProductId" label="ProductId"
                      onChange={e=>  setNewProduct({ ...newProduct , ProductId : e.target.value })}   
                  />
                  </Grid>
                  <Grid item xs={12}>
                  <TextField variant="outlined" required fullWidth name="ProductName" label="ProductName"
                  ...
                  <Grid item xs={12}>
                    ...
                    <FormControl fullWidth variant="outlined" className={classes.formControl}>
                        <Select  native    onChange={e=>  setNewProduct({ ...newProduct , CompanyId : e.target.value })}  >
                            <option value=""></option>
